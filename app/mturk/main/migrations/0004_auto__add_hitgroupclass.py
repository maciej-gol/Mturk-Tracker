...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HitGroupClass'
        db.create_table('main_hitgroupclass', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('group_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50, db_index=True)),
            ('classes', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
            ('probabilities', self.gf('django.db.models.fields.CharField')(max_length=1000)),
        ))
        db.send_create_signal('main', ['HitGroupClass'])


    def backwards(self, orm):
        # Deleting model 'HitGroupClass'
        db.delete_table('main_hitgroupclass')
