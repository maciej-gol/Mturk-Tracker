...
from mturk.main.migration_extra import procedures
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        procedures.create_all()

        # Adding field 'CrawlAgregates.hitgroups_posted'
        db.add_column('main_crawlagregates', 'hitgroups_posted',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'CrawlAgregates.hitgroups_consumed'
        db.add_column('main_crawlagregates', 'hitgroups_consumed',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'CrawlAgregates.rewards_posted'
        db.add_column('main_crawlagregates', 'rewards_posted',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        # Adding field 'CrawlAgregates.rewards_consumed'
        db.add_column('main_crawlagregates', 'rewards_consumed',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'CrawlAgregates.hitgroups_posted'
        db.delete_column('main_crawlagregates', 'hitgroups_posted')

        # Deleting field 'CrawlAgregates.hitgroups_consumed'
        db.delete_column('main_crawlagregates', 'hitgroups_consumed')

        # Deleting field 'CrawlAgregates.rewards_posted'
        db.delete_column('main_crawlagregates', 'rewards_posted')

        # Deleting field 'CrawlAgregates.rewards_consumed'
        db.delete_column('main_crawlagregates', 'rewards_consumed')
