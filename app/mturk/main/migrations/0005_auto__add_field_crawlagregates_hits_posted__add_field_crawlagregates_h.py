...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CrawlAgregates.hits_posted'
        db.add_column('main_crawlagregates', 'hits_posted',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True),
                      keep_default=False)

        # Adding field 'CrawlAgregates.hits_consumed'
        db.add_column('main_crawlagregates', 'hits_consumed',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CrawlAgregates.hits_posted'
        db.delete_column('main_crawlagregates', 'hits_posted')

        # Deleting field 'CrawlAgregates.hits_consumed'
        db.delete_column('main_crawlagregates', 'hits_consumed')
